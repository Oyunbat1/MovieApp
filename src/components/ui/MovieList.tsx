...
function MovieList(props:Props) {
  return (
    <div>
        <div>      <div className="flex  px-[30px] justify-between">
        <div>
        ...
        <div className="w-full flex flex-col items-center p-[10px] bg-slate-400 rounded-md"  key={index}>
      ...
      <img
        ...
        ></img>
          ...
          <div className='flex items-center'>
                        <Image  src="/star.svg" width={10} height={50} alt='Movie Logo'/>
                            <p className='text-[#71717A] text-[12px]'><span className='font-bold text-[12px
