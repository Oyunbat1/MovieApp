...
function Scroll() {
  ...
  const [nowPlayingMovie, nowPlayingMovieSet] = useState<Movie[]>([]);
  const [videoUrl, setVideoUrl] = useState<string | null>(null); // Store trailer URL
                  ...
                  <CarouselItem key={index}>
                    <div className="relative text-white mb-[30px]">
                      ...
                      <div className="flex flex-col p-[46px] gap-4 lg:gap-12 absolute z-10 top-1/2 left-1/3 lg:left-1/4 transform -translate-x-1/2 -translate-y-1/2 w-[404px]">
                        <div className="flex flex-col justify-between text-white">
                          ...
                          <div className="flex items-center">
                            ...
                            <p className="text-[#71717A] xl-text-[20px]">
                              <span className="font-bold text-[18px] xl:text-[20px] text-white">
                                {movie.vote_average}
                              </span>
                              /10
                            </p>
                        ...
                        <Button
                          className="w-[150px] h-[40px] bg-white text-black"
                          onClick={() => fetchTrailer(movie.id)}
                        >
                          <Image
